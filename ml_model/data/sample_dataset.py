...
LEGITIMATE_MESSAGES = [
    ...
    # Urgent / fear-driven additions
    ("CRITICAL SECURITY NOTICE: We detected a forced login attempt on your profile from an unknown device in Delhi. Confirm your identity immediately or your total balance will be permanently frozen!", 1, "urgent"),
    ("GOVERNMENT TAX WARNING: A legal non-compliance case has been registered under your identity. Pay the pending settlement amount of ₹45,000 right away at this link to cancel the local police warrant!", 1, "urgent"),
    ("ALERT: Your linked device has requested a master pin reset. If this was not you, call our central fraud helpline at 1800-555-0122 NOW to intercept the unauthorized withdrawal!", 1, "urgent"),
    ("FINAL CHANCE: Your commercial electricity service connection lapses tonight due to an unresolved billing variance. Remit your overdue invoice within 30 minutes to bypass disconnection status!", 1, "urgent"),
    ("URGENT MEMO: Suspicious international wire requests for $5,400 were flagged on your credit file. Authenticate your 2FA security profile instantly to block this transaction!", 1, "urgent"),
    ("WARNING! You are in violation of regulatory compliance guidelines. Tap http://compliance-verify-portal.net inside the next 15 minutes to dispute file restrictions or face automatic penalties!", 1, "urgent"),
    # Greedy / prize lure additions
    ("CONGRATULATIONS! Your mobile number was chosen for the 2026 International Rewards Program. Claim your unallocated prize package worth ₹2,50,000 by verifying your bank branch data!", 1, "greedy"),
    ("EXCLUSIVE AIRDROP: You have been allocated a bonus stake of 2.50 BTC from our community giveaway pool. Complete your processing configuration at http://free-crypto-claim.org to release it!", 1, "greedy"),
    ("EARN WEEKLY: Become a part-time remote media analyst from your living room and clear up to ₹35,000 every single week. No previous background required. Pay your onboarding security deposit to register!", 1, "greedy"),
    ("INVESTMENT TRADING SECRET: Double your financial savings inside 7 days via our automated stock arbitrage algorithms. Minimum starting balance required is only $250. 100% guaranteed profit matrix!", 1, "greedy"),
    ("UNCLAIMED FUNDS: Our audit division has recovered an inherited asset account worth $1.8 Million listed under your family name. Contact our legal representatives immediately to authorize delivery!", 1, "greedy"),
    ("LUCKY DRAW WINNER: You are occupant #3 to claim a luxury electric scooter reward voucher. Send your direct bank details along with a processing fee of ₹1,499 to process your cargo logistics!", 1, "greedy"),
    # Friendly / trust-building additions
    ("Hello, I am reaching out to you privately because your social profile showed up as someone incredibly sincere. I have a confidential proposal regarding an asset estate that requires an honest partner.", 1, "friendly"),
    ("Hi dear! I am a volunteer doctor deployed on a humanitarian mission abroad. It is hard to find people I can genuinely rely on, but I would really love to build a lasting friendship with you.", 1, "friendly"),
    ("Hey, a mutual acquaintance from your neighborhood highly recommended your background for an exclusive business opportunity. Let's keep this conversation completely private for now until we finalize the steps.", 1, "friendly"),
    ("I know this approach out of nowhere looks quite unusual, but I feel a very strong personal connection to you. I am looking for someone trustworthy who can manage a sensitive family matter for me.", 1, "friendly"),
    ("Please do not tell any bank officials or family members about this arrangement just yet. I trust you more than anyone else, and I want to guarantee our special investment stays completely safe.", 1, "friendly"),
    ("Hello, I noticed we share quite a few professional interests and I wanted to personal extend an exclusive invitation to you. Let's build real trust first before we talk about financial profit models.", 1, "friendly"),
    # Phishing / credential-harvesting additions
    ("SBI BANK NOTIFICATION: Your online netbanking profiles will be deactivated due to an outdated KYC checklist. Please synchronize your credentials at http://sbi-kyc-update-portal.in safely.", 1, "urgent"),
    ("HDFC EMERGENCY GATEWAY: We have intercepted an irregular transaction request for ₹89,420 from your saving ledger. To intercept this transaction, enter your OTP immediately at http://hdfc-secure-auth.co", 1, "urgent"),
    ("AMAZON APPRECIATION DEED: You have been awarded an exclusive ₹10,000 promotional gift balance for being a premier club customer. Redeem your reward package before it expires tonight at http://amazon-gift-collect.net", 1, "greedy"),
    ("PAYTM COMPLIANCE UPGRADE: Immediate verification is mandatory for your merchant account to retain continuous wallet access limits. Re-verify your PAN and card records inside 2 hours at http://paytm-wallet-verify.com", 1, "urgent"),
    ("NETFLIX SUBSCRIPTION FAULT: Your monthly recurring payment method was declined by the card processor. Renew your payment profile within 24 hours to avoid profile deletion: http://netflix-billing-renew.com", 1, "urgent"),
    ("YONOSBI COMPLIANCE ALERT: Your savings vault has been restricted temporarily due to abnormal terminal activations. Unfreeze your profile now via http://yonosbi-security-login.net to maintain access.", 1, "urgent"),
]
